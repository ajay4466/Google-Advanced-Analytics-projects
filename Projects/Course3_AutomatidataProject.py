...
# I will check for negative values and would check the box plot and scatter plot to find outliers
...
#==> ENTER YOUR CODE HERE
plt.hist(df['total_amount'],bins = 30 , color = 'skyblue')
...
#==> ENTER YOUR CODE HERE
plt.hist(df['tip_amount'],bins = 10 , color = 'skyblue')
...
daily_rides = daily_rides.reindex(index = day_week)
