...
# only year founded has data type of integer rest all are object

# **Question: How many columns contain null values?**

# none of the column has null value
...
# The coloumn 'City' has 16 null values and column 'Select Investor' has 1 nullvalue
...
# Singapore country shows up a lot in the missisng value dataframe.

# **Question: What steps did you take to find missing data?**
# 

# DataFrame.isna() gave us boolean df where for eevery NaN value it will return True
# Used sum() along with isna() to get the count 
# used any() along with isna() to get boolean mask which applied on whole dataframe to obtain just the rows
...
# Get domain knowledge and ask the business users for missing data
...
print(f"Percent removed , rows: {row_percent:.3f}")
# Print the percentage of values removed by dropping columns.

### YOUR CODE HERE ###
column_percent = ((count_total - count_dropna_columns)/count_total)*100
print(f"Percent removed , column: {column_percent:.3f}")


# **Question: Which method was most effective? Why?**
# 

# Dropping rows and columns lead to significant data loss but if have to choose one dropping rows would make sense as its just 1.583% and for column its 16.667%.the "most effective" method depends on how much data you have and what you want to do with it.
...
# No it doesnt make sense as some cities which arent part of that region is also labelled there.
...
# 8 companies meet the criteria given by the investor
...
#     USA has the highest sum of valuation followed by China
...
# By the size in the graph

# **Question: Does any region stand out as having a lot of activity?**
# 

# Europe stands out other than big4 countries
