...
# 1) Client can see how fast growing is a sector
# 2) analyze which are the fastest growing sector
# identify its competitors and invest in the sector
...
# Only one row has negative value (-3) where company name is InVision 
...
#  assigning each category a unique number instead of a qualitative value.
